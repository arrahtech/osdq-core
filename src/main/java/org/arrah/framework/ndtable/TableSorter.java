...
public class TableSorter extends AbstractTableModel implements Serializable {
	...
	private static class Arrow implements Icon, Serializable {
		...
		public void paintIcon(Component c, Graphics g, int x, int y) {
			...
			// In a compound sort, make each successive triangle 5%
			// smaller than the previous one.
			int dx = (int) (size / 2 * Math.pow(0.95, priority));
